...
<!-- ||||||||||||||||||||||||  BLOCO GENÉRICO |||||||||||||||||||||||| -->
<section id="<?php the_sub_field('acf_block_generic__id'); ?>" class="structure-main__section <?php the_sub_field('acf_block_generic__type_layout'); ?> <?php if( !empty( get_sub_field('acf_block_generic__custom_background_image') ) ): echo 'section-background-image'; endif; ?>"
